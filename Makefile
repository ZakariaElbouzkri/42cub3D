...
$(NAME): $(OBJ)
	...
	@echo "\033[1;32m$@ has been created\033[0m"

%.o: %.c $(INC)
	@$(CC) -c $< -o $@ $(INCLUDEDIRS)
	@echo "\033[1;32mcompiling $< ... \033[1;36mDone\033[0m"
	@sleep 0.01
	@clear
